...
import { ChevronRight, FileText, Download, BookText } from "lucide-react";
...
export default async function InvestorsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f3fe]">
      ...
      {/* Annual reports */}
      <div id="annual-reports" className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 py-12 scroll-mt-24">
