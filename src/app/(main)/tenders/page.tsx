...
const tenders: Tender[] = [
  {
    id: 1,
    title: "Supply & Installation of ATM Machines",
    category: "IT Equipment",
    reference: "TB-2025-001",
    tenderType: "Supply & Installation",
    publishedDate: "01 Feb 2026",
    closingDate: "30 Apr 2026",
    status: "Open",
    description:
      "CoopBank Tanzania invites qualified vendors to supply and install ATM machines across selected branch locations. Bidders must demonstrate experience in ATM deployment, maintenance support, and integration with core banking systems.",
  },
  {
    id: 2,
    title: "Provision of Security Guard Services",
    category: "Services",
    reference: "TB-2026-002",
    tenderType: "Service Contract",
    publishedDate: "20 Feb 2026",
    closingDate: "02 Apr 2026",
    status: "Open",
    description:
      "We seek proposals from reputable security firms to provide professional guard services at our branches and head office locations. Firms must be licensed and have experience in financial institution security.",
  },
  {
    id: 3,
    title: "Construction of New Branch - Dodoma City",
    category: "Construction",
    reference: "TB-2026-003",
    tenderType: "Construction Works",
    publishedDate: "05 Feb 2026",
    closingDate: "May 2026",
    status: "Open",
    description:
      "Invitation for registered contractors to participate in the construction of a new CoopBank branch in Dodoma City. The project includes civil works, electrical installation, plumbing, and interior finishing to bank specifications.",
  },
  {
    id: 4,
    title: "Supply of Office Furniture & Equipment",
    category: "Goods",
    reference: "TB-2026-004",
    tenderType: "Supply",
    publishedDate: "20 Feb 2026",
    closingDate: "15 Apr 2026",
    status: "Open",
    description:
      "CoopBank Tanzania is looking for suppliers of office furniture and equipment including desks, chairs, filing cabinets, and related office equipment for new and existing branches.",
  },
  {
    id: 5,
    title: "Core Banking System Upgrade Consulting",
    category: "IT Services",
    reference: "TB-2026-005",
    tenderType: "Consulting Services",
    publishedDate: "10 Mar 2026",
    closingDate: "Mid-May 2026",
    status: "Open",
    description:
      "We invite experienced IT consulting firms to submit proposals for advisory and implementation support for our core banking system upgrade. The engagement covers system assessment, migration planning, testing, and go-live support.",
  },
];
...
type FilterTab = "All Tenders" | "Open" | "Closed";
...
export default function TendersPage() {
  const [activeFilter, setActiveFilter] = useState<FilterTab>("All Tenders");
          ...
          <div className="space-y-5">
            <AnimatePresence mode="popLayout">
              {filteredTenders.map((tender) => {
                const config = categoryConfig[tender.category];
                          ...
                          >
                            <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
                              ...
                              <p className="mt-3 text-xs text-body/60">
                                Reference: {tender.reference} | Closing:{" "}
                                {tender.closingDate}
                              </p>
                            </div>
                          </motion.div>
