// Global root not-found. This catches ANY unmatched URL across the whole app
// (e.g. old-site links like /carees). Because the marketing site uses (main)
// as a root layout and there is intentionally NO src/app/layout.tsx, this file
// must render its own <html>/<body>, font and globals.css — otherwise Next.js
// falls back to its bare built-in 404. Kept as a server component (no
// framer-motion) so it renders reliably outside every route group.
...
export const metadata: Metadata = {
  title: "Page Not Found | Cooperative Bank Tanzania Plc.",
  description:
    "The page you are looking for could not be found. Let us help you get back on track.",
        ...
        <section className="relative overflow-hidden pt-32 pb-24 sm:pt-36 sm:pb-32">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            ...
            <p className="text-white/60 max-w-xl mx-auto text-lg leading-relaxed mb-10">
              ...
              temporarily unavailable. Let us help you find your way back.
            </p>
